...
public class MoviesUpdaterOrderArray {
	
	public static void main(String[] args) {
		JSONObject mainJSONObject = Utility.readJSON("movies_list23.txt");
			...
			if (myMovieJSONObject.has("myData")) {
				...
				if (myDataJSONObject.has("title")) {
					...
					if (myTitleJSONObject.has("nt")) {
						...
						if (t.contains(" the ") || t.contains(" of ")) {
							s = "en";
		...
		Utility.writeFile(mainJSONObject, "movies_list24.txt");
	}
