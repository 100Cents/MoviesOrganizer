		...
		if (originalTitle != null) {
			if (translatedTitle != null) {
				if (originalTitle.equals(translatedTitle)) {
					...
					return originalTitle + " [" + translatedTitle + "] (" + getYear() + ")";
				}
			} else {
				return originalTitle + " (" + getYear() + ")";
			}
			...
			if (translatedTitle != null) {
				return translatedTitle + " (" + getYear() + ")";
			}
		}
		return null;
	}
		...
		if (originalTitle != null) {
			if (translatedTitle != null) {
				if (originalTitle.equals(translatedTitle) || translatedTitle.equals("")) {
					return correctForDirectory(originalTitle + " (" + getYear() + ")");
				} else {
					return correctForDirectory(originalTitle + " [" + translatedTitle + "] (" + getYear() + ")");
				}
			} else {
				return correctForDirectory(originalTitle + " (" + getYear() + ")");
			}
			...
			if (translatedTitle != null && !translatedTitle.equals("")) {
				return correctForDirectory(translatedTitle + " (" + getYear() + ")");
			}
		}
		return null;
	}
